...
export const SUGGESTED_PROMPTS = [
  ...
  // },
  {
    title: "Flashcard app",
    description:
      "Build me a flashcard app about InnoDEV Coders. Have some flash cards and also have the ability for users to add their own. Show one side of a card at first and reveal the answer on button click, keeping track of correct guesses to measure progress.",
  },
  {
