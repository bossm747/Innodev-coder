...
export default function Home() {
  ...
  return (
    <div className="relative flex grow flex-col bg-purple-900 text-white">
      <div className="absolute inset-0 flex justify-center">
        <Image
          src={bgImg}
          alt=""
          className="max-h-[953px] w-full max-w-[1200px] object-cover object-top mix-blend-screen opacity-20"
          priority
        />
      </div>
      ...
      <div className="isolate flex h-full grow flex-col">
        ...
        <div className="mt-10 flex grow flex-col items-center px-4 lg:mt-16">
          <a
            className="mb-4 inline-flex shrink-0 items-center rounded-full border-[0.5px] bg-purple-700 px-7 py-2 text-xs text-white shadow-[0px_1px_1px_0px_rgba(0,0,0,0.25)] md:text-base"
            href="https://togetherai.link/?utm_source=innodevcoder&utm_medium=referral&utm_campaign=example-app"
            target="_blank"
          >
            <span className="text-center">
              Powered by <span className="font-semibold">InnovateHub AI</span>.
            </span>
          </a>

          <h1 className="mt-4 text-balance text-center text-4xl leading-none text-white md:text-[64px] lg:mt-8">
            Turn your <span className="text-blue-300">idea</span>
